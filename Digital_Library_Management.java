...
class Library {
    ...
    public void returnBook(Book book) {
        if (loggedInUser != null && loggedInUser instanceof User) {
            // Logic to return a book by the user
...
public class Digital_Library_Management_System {
    public static void main(String[] args) {
        ...
        Book b1 = new Book("Algorithms", "Robert Sedgewick");
        books.add(b1);
        Book b2 = new Book("Head First Java", "Kathy Sierra");
        books.add(b2);
        Book b3 = new Book("Elegant Objects", "Yegor Bugayenko");
        books.add(b3);
        ...
        while (!exit) {
            ...
            System.out.println("7. Update Book (Admin Only)");
